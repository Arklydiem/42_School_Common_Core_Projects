...
/*   Updated: 2023/03/22 09:49:47 by argomez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(const std::string &target){
	...
	std::cout << "\e[38;5;141mScavTrap\e[0m " << this->_name << " attacks " << target << ", causing " << this->_attackDamage << " points of damage!" << std::endl;
	this->_energyPoint--;
}
